  ...
  content: [
    ...
    },
    {
      ...
      description: {
        ...
        overlay: 'Tech Wars 2026 is Warren CAT\'s technician skills competition, the best in the territory going head-to-head on diagnostics, repairs, and speed. It\'s also the answer to anyone who thinks technician work is a fallback career: this trade has a skill ceiling worth competing over, and the company celebrates the people climbing it. Save the card and the highlights arrive in your follow-up email.',
      },

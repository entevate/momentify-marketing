...
export const BIOLABS_CONFIG: ExplorerConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'equipment', label: 'Equipment & Facilities', icon: 'microscope', iconType: 'lucide',
          relevantRoles: ['founder', 'scientist', 'browsing'] },
        { value: 'golden-tickets', label: 'Golden Tickets', icon: 'ticket', iconType: 'lucide',
  ...
  content: [
    ...
    {
      id: 'o2',
      title: '19 Locations, 3 Continents',
      cardType: 'outcome',
      icon: 'globe',
      iconType: 'lucide',
      stat: '20+',
    ...
    {
      id: 'l5',
      title: 'Explore All 19 Locations',
      cardType: 'learn',
      mediaType: 'website',
      icon: 'map',
      iconType: 'lucide',
      url: 'https://www.biolabs.io/locations',
      description: {
        small: 'The full network directory, from Boston to Tokyo.',
        medium: 'Browse every BioLabs site — teams, spaces, and local ecosystems across the US, Europe, and Asia.',
        large: 'The locations directory covers all 19 sites: photos, local team rosters, space specifics, and the innovation ecosystem each site plugs into — from Kendall Square to Charite to Kawasaki.',
    ...
    },
    {
      ...
      url: 'https://www.biolabs.io/locations',
      description: {
        small: 'Land in any cluster the science needs — 19 sites, 3 continents.',

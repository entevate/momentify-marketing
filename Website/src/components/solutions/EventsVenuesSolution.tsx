    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12" style={{ paddingTop: "140px", paddingBottom: "100px" }}>
          ...
          >
            <div className="relative w-full" style={{ aspectRatio: "16 / 9", background: "rgba(6, 19, 65, 0.4)", border: "1px solid rgba(249, 160, 142, 0.15)", borderRadius: "16px", overflow: "hidden", backdropFilter: "blur(12px)" }}>
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                ...
                <p style={{ fontFamily: "var(--font-inter)", fontWeight: 500, fontSize: "12px", color: "rgba(255, 255, 255, 0.60)", letterSpacing: "0.02em" }}>Venues &amp; Events Video Walk-Thru</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full" style={{ aspectRatio: "1 / 1", background: "rgba(6, 19, 65, 0.4)", border: "1px solid rgba(249, 160, 142, 0.15)", borderRadius: "16px", overflow: "hidden", backdropFilter: "blur(12px)" }}>
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                ...
                <p style={{ fontFamily: "var(--font-inter)", fontWeight: 500, fontSize: "13px", color: "rgba(255, 255, 255, 0.60)", letterSpacing: "0.02em" }}>Venues &amp; Events Video Walk-Thru</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="rgba(249,160,142,0.5)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
